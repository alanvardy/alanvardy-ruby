...
class ProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create project when logged in' do
    ...
    assert_difference('Project.count', 1) do
      post projects_url, params: { project: { description: @project.description,
                                              giturl: @project.giturl, image: @project.image, more: @project.more, title: @project.title, weburl: @project.weburl } }
    end
  ...
  test "shouldn't update project when not logged in" do
    patch project_url(@project), params: { project: { description: @project.description,
                                                      giturl: @project.giturl, image: @project.image, more: @project.more, title: @project.title, weburl: @project.weburl } }
    assert_redirected_to sessions_new_path
    @project.reload
  ...
  test 'should update project when logged in' do
    login_user
    patch project_url(@project), params: { project: { description: @project.description,
                                                      giturl: @project.giturl, image: @project.image, more: @project.more, title: '1111', weburl: @project.weburl } }
